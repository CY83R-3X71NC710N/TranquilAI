...
- Why I avoid Video Wallpapers? Because Video Wallpapers often get boring very easily and because there usually are not many of them it's hard to get mass-downloads for them. Additionally, using video wallpapers requires using a third party tool which consumes system resources and may not even be avaliable on all operating systems, additionally I just appreciate the overall aestetics and thought that goes into a photo. Furthermore, Videos are harder to edit and manipulate than a photo which is more work than I'm willing to put in for a wallpaper.
